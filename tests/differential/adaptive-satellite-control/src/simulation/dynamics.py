...
def attitude_dynamics(
    ...
    h_int: np.ndarray, optional, shape (3,)
    ...
    return np.linalg.solve(J_B, total_torque)  # TODO: faster solving by precomputing stuff because J is constant
...
class SGP4:
    ...
    @classmethod
    def from_tle(cls, tle1: str, tle2: str, earth_grav: Any = WGS84) -> "SGP4":
        """
